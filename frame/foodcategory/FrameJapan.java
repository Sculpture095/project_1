...
public class FrameJapan extends JPanel {
JPanel frameJapanPanel;
	
	public FrameJapan(JPanel homePanel) {
		this.frameJapanPanel = homePanel;
		...
		ImageIcon mainBg = new ImageIcon("img/list_3_bg.jpg");

...
public class FrameAmerican extends JPanel {
JPanel frameAmericanPanel;
	
	public FrameAmerican(JPanel homePanel) {
		this.frameAmericanPanel = homePanel;
		...
		ImageIcon mainBg = new ImageIcon("img/list_4_bg.jpg");

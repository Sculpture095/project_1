...
public class FrameFastfood extends JPanel{
JPanel frameFastfoodPanel;
	
	public FrameFastfood(JPanel homePanel) {
		this.frameFastfoodPanel = homePanel;
		...
		ImageIcon mainBg = new ImageIcon("img/list_7_bg.jpg");

...
public class FrameCafe extends JPanel{
JPanel frameCafePanel;
	
	public FrameCafe(JPanel homePanel) {
		this.frameCafePanel = homePanel;
		...
		ImageIcon mainBg = new ImageIcon("img/list_9_bg.jpg");

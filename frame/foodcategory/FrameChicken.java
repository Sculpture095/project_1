...
public class FrameChicken extends JPanel{
JPanel frameChickenPanel;
	
	public FrameChicken(JPanel homePanel) {
		this.frameChickenPanel = homePanel;
		...
		ImageIcon mainBg = new ImageIcon("img/list_5_bg.jpg");

...
public class FrameChina extends JPanel{
JPanel frameChinaPanel;
	
	public FrameChina(JPanel homePanel) {
		this.frameChinaPanel = homePanel;
		...
		ImageIcon mainBg = new ImageIcon("img/list_2_bg.jpg");
